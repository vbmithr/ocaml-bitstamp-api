...
(* OASIS_START *)
(* DO NOT EDIT (digest: 94ade6f5125ca699b52d405d60c318fe) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "bitstamp"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "all_transactions.ml";
                      })
            ];
          plugins =
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\205\201\194\213\146\248\031C\174-)x\012\248vX";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
